...
<table style="border-collapse: collapse;">
  <tr>
    ...
    <th style="border: 3px solid white;">トークン発行リクエスト</th>
    <th style="border: 3px solid white; background-color: gray;">物理名：</th>
    <th style="border: 3px solid white;">TokenRequest</th>
    <th style="border: 3px solid white; background-color: gray;">継承元：</th>
    <th colspan="2" style="border: 3px solid white;">UserCreateRequest</th>
  </tr>
  <tr>
    <th style="border: 3px solid white; background-color: gray;">論理名</th>
    <th style="border: 3px solid white; background-color: gray;">物理名</th>
