<table style="border-collapse: collapse;">
    <tr>
        ...
        <th colspan="4" style="border: 3px solid white;">CLUD/復習項目操作/復習項目取得</th>
    ...
    <tr>
        ...
        <td style="border: 1px solid white;">返り値の型が `list[ReviewGetResponse]` となっているが、備考に「取得できない場合はNoneを返す」と記載されている。Noneを返す可能性がある場合、型は `list[ReviewGetResponse] | None` と定義すべきである。</td>
