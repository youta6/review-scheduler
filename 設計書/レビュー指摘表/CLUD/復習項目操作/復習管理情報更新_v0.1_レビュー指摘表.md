<table style="border-collapse: collapse;">
    <tr>
        ...
        <th colspan="4" style="border: 3px solid white;">CLUD/復習項目操作/復習管理情報更新</th>
    ...
    <tr>
        ...
        <td style="border: 1px solid white;">当初は単一のReviewManagementを返す想定だった。mainでの処理をやりやすくするため、リストでの返却に変更したが、該当箇所の修正が漏れていた。</td>
        <td style="border: 1px solid white;">論理名を「復習管理情報」→「復習管理情報リスト」、物理名を「review_management」→「review_management_list」に修正</td>
