<table style="border-collapse: collapse;">
    <tr>
        ...
        <th colspan="4" style="border: 3px solid white;">CLUD/復習項目操作/復習情報更新</th>
    ...
    <tr>
        ...
        <td style="border: 1px solid white;">指摘通り修正する。</td>
        <td style="border: 1px solid white;">「REVIEWテーブルを更新」の検索条件の「復習id」を「復習項目id」に修正</td>
        <td style="border: 1px solid white;">youta6</td>
        <td style="border: 1px solid white;">2026/6/11</td>
        <td style="border: 1px solid white;">2026/6/11</td>
        <td style="border: 1px solid white;"></td>
    ...
    <tr>
        ...
        <td style="border: 1px solid white;">2026/6/9</td>
        <td style="border: 1px solid white;">単純ミス</td>
        <td style="border: 1px solid white;">記載漏れ。指摘通りに修正</td>
        <td style="border: 1px solid white;">引数「復習項目」の最小桁に「1」を記載</td>
        <td style="border: 1px solid white;">youta6</td>
        <td style="border: 1px solid white;">2026/6/11</td>
        <td style="border: 1px solid white;">2026/6/11</td>
        <td style="border: 1px solid white;"></td>
