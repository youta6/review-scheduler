<table style="border-collapse: collapse;">
    <tr>
        ...
        <th colspan="4" style="border: 3px solid white;">サーバー処理（main）/復習項目操作/復習項目削除</th>
    ...
    <tr>
        ...
        <td style="border: 1px solid white;">メソッド名の論理名が「復習項目作成」となっているが、本設計書は復習項目削除処理であり「復習項目削除」と記載すべきである。物理名 `delete_review_endpoint` とも不整合である。</td>
        <td style="border: 1px solid white;">33</td>
        ...
        <td style="border: 1px solid white;">メソッド名を「復習項目作成」→「復習項目削除」に修正</td>
