<table style="border-collapse: collapse;">
    <tr>
        ...
        <th colspan="3" style="border: 3px solid white;">認証・認可（auth）/トークン発行</th>
    ...
    <tr>
        ...
        <td style="border: 1px solid white;">引数「データベース」の物理名が `data` となっているが、他のすべての設計書（main、crud層）ではデータベースセッションの物理名は `db` で統一されている。命名規則統一のため `db` に修正すべきである。</td>
        <td style="border: 1px solid white;">91</td>
