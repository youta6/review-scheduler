...
<table style="border-collapse: collapse;">
    ...
    <tr>
        <th rowspan="6" style="border: 3px solid white; background-color: gray;">取得内容</th>
...
<table style="border-collapse: collapse;">
    ...
    <tr>
        <td colspan="3" style="border: 1px solid white; border-bottom: none;">ユーザー情報リスト</td>
        <td style="border: 1px solid white;">user_list</td>
