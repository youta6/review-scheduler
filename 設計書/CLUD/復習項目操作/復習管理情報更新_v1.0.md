...
<table style="border-collapse: collapse;">
    ...
    <tr>
        ...
        <td style="border: 1px solid white;">update_review_management</td>
    </tr>
</table>
...
<table style="border-collapse: collapse;">
    ...
    <tr>
        ...
        <td style="border: 1px solid white;">復習管理情報更新．レスポンス</td>
        <td style="border: 1px solid white;">mainの処理を考慮してリストで返却<br>復習管理情報が見つからない場合は空のリストを返す</td>
    </tr>
</table>