...
<table style="border-collapse: collapse;">
    ...
    <tr>
        <td style="border: 1px solid white;">復習管理情報削除</td>
        <td style="border: 1px solid white;">delete_review_management</td>
    </tr>
</table>
...
<table style="border-collapse: collapse;">
    ...
    <tr>
        <td style="border: 1px solid white;">削除件数</td>
        <td style="border: 1px solid white;">count</td>
        <td style="border: 1px solid white;">int</td>
        <td style="border: 1px solid white;">復習管理情報削除．レスポンス</td>
        <td style="border: 1px solid white;">復習管理情報が見つからない場合はNoneを返す</td>
    </tr>
</table>