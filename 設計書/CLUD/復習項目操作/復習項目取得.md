...
<table style="border-collapse: collapse;">
    ...
    <tr>
        ...
        <td style="border: 1px solid white;">復習情報取得．復習項目</td>
        <td style="border: 1px solid white;">-</td>
    </tr>
    <tr>
        <td style="border: 1px solid white;">復習内容詳細</td>
        <td style="border: 1px solid white;">str</td>
        <td style="border: 1px solid white;">復習情報取得．復習内容詳細</td>
        <td style="border: 1px solid white;">-</td>
    </tr>
    <tr>
        <td style="border: 1px solid white;">学習日</td>
        <td style="border: 1px solid white;">datetime</td>
        <td style="border: 1px solid white;">復習情報取得．学習日</td>
        <td style="border: 1px solid white;">-</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="border: 1px solid white;">int</td>
        <td style="border: 1px solid white;">復習情報取得．復習回</td>
        <td style="border: 1px solid white;">-</td>
    </tr>
    <tr>
        <td style="border: 1px solid white;">復習予定日</td>
        <td style="border: 1px solid white;">datetime</td>
        <td style="border: 1px solid white;">復習情報取得．復習予定日</td>
        <td style="border: 1px solid white;">-</td>
    </tr>
    <tr>
        <td style="border: 1px solid white;">対応済みフラグ</td>
        <td style="border: 1px solid white;">boolean</td>
        <td style="border: 1px solid white;">復習情報取得．対応済みフラグ</td>
        <td style="border: 1px solid white;">-</td>
    </tr>
</table>