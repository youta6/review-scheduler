<table style="border-collapse: collapse;">
    <tr>
        ...
        <th colspan="2" style="border: 3px solid white;">UserDeleteRequest</th>
    ...
    <tr>
        ...
        <td style="border: 1px solid white;">JWT認証済みの操作であるため、UserDeleteRequestのpasswordフィールドは不要だが削除されていない。設計工程レビュー（CLUD/ユーザー操作/ユーザー情報削除_レビュー指摘表　指摘No.3）にてパスワード照合不要の指摘があったにもかかわらず、schemas.pyへの反映が漏れていた。再鑑時も同様に見落とし。</td>
        <td style="border: 1px solid white;">64</td>
        ...
        <td style="border: 1px solid white;">修正する。</td>
        <td style="border: 1px solid white;">schemas.pyのUserDeleteRequestからpasswordフィールドを削除し、crud.pyのDELETE WHERE句もhashed_passwordなしで動作するよう合わせて修正する。</td>
        <td style="border: 1px solid white;">youta6</td>
