<table style="border-collapse: collapse;">
    <tr>
        ...
        <th colspan="2" style="border: 3px solid white;">ReviewGetResponse</th>
    ...
    <tr>
        ...
        <td style="border: 1px solid white;">復習項目更新では復習項目IDを指定するが、ユーザーから確認するすべがない。復習項目作成か復習項目取得で確認できるようにするべき。</td>
        <td style="border: 1px solid white;">214</td>
        ...
        <td style="border: 1px solid white;">復習項目作成で復習IDが返却されるようにする。</td>
        <td style="border: 1px solid white;">`ReviewGetResponse`に`review_id`を追加する。</td>
        <td style="border: 1px solid white;">youta6</td>
        <td style="border: 1px solid white;">2026/6/18</td>
        <td style="border: 1px solid white;">2026/6/18</td>
