<table style="border-collapse: collapse;">
    <tr>
        ...
        <th colspan="2" style="border: 3px solid white;">UserGetRequest</th>
    ...
    <tr>
        ...
        <td style="border: 1px solid white;">UserGetRequestのuser_nameは任意項目だが、UserBaseを継承しているため必須扱いになっている。再鑑時も同様に見落とし。</td>
        ...
        <td style="border: 1px solid white;">UserGetRequestのuser_nameを任意項目にする。</td>
        <td style="border: 1px solid white;">UserGetRequestはBaseModelを継承し、user_nameを定義する。</td>
        <td style="border: 1px solid white;">youta6</td>
