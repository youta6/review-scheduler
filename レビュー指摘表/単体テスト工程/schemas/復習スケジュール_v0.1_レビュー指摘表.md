<table style="border-collapse: collapse;">
    <tr>
        ...
        <th colspan="2" style="border: 3px solid white;">ReviewSchedule</th>
    ...
    <tr>
        ...
        <td style="border: 1px solid white;">review_timeは`ge=1, le=1`と1しか許容していない。設計から`ge=1, le=5`とするのが正しい。</td>
        <td style="border: 1px solid white;">151</td>
        ...
        <td style="border: 1px solid white;">`le`は最大桁数だと勘違いしていた。指摘通り修正する。</td>
        <td style="border: 1px solid white;">review_timeのFieldは`ge=1, le=5`に修正。<br>`ReviewScheduleWithDoneFlag`と`ReviewUpdateRequest`も同様に修正</td>
        <td style="border: 1px solid white;">youta6</td>
        <td style="border: 1px solid white;">2026/6/17</td>
