<table style="border-collapse: collapse;">
    ...
    <tr>
        ...
        <td style="border: 1px solid white;">`from sqlalchemy.ext.declarative import declarative_base`は非推奨。<br>`sqlalchemy.orm`の`declarative_base`を使用することを推奨</td>
        ...
        <td style="border: 1px solid white;">`declarative_base`は`sqlalchemy.ext.declarative`ではなく`sqlalchemy.orm`のものを使用する</td>
        <td style="border: 1px solid white;">youta6</td>
        <td style="border: 1px solid white;">2026/6/17</td>
        <td style="border: 1px solid white;">2026/6/17</td>
