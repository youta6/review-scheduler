<table style="border-collapse: collapse;">
    <tr>
        ...
        <th colspan="4" style="border: 3px solid white;">エンドポイント</th>
        ...
        <th colspan="2" style="border: 3px solid white;">2026/6/10</th>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="border: 1px solid white;">認証・認可設計書「トークン発行（generate_token）」のエンドポイントが本設計書に記載されていない。トークン発行設計書のエンドポイントテーブルでは機能・HTTPメソッド・エンドポイントがすべて「-」となっており未定義だが、FastAPIのOAuth2認証パターンに基づくと `POST /token` エンドポイントが必要である。エンドポイント設計書にトークン発行エンドポイントを追加すべきである。</td>
        <td style="border: 1px solid white;">3-64</td>
        ...
        <td style="border: 1px solid white;">エンドポイントの理解不足のためハイフンにしていた。</td>
        <td style="border: 1px solid white;">「エンドポイント.md」にトークン発行の行追加。<br>「認証・認可/トークン発行.md」のエンドポイント記載</td>
        <td style="border: 1px solid white;">youta6</td>
        <td style="border: 1px solid white;">2026/6/10</td>
        <td style="border: 1px solid white;">2026/6/10</td>
        <td style="border: 1px solid white;">Claude Sonnet 4.6</td>
