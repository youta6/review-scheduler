<table style="border-collapse: collapse;">
    ...
    <tr>
        ...
        <td style="border: 1px solid white;">269行目で`created_at=auth.updated_at`となっており、作成日に更新日の値が設定されている。`created_at=auth.created_at`に修正すべきである。</td>
        <td style="border: 1px solid white;">269</td>
        ...
        <td style="border: 1px solid white;">`created_at=auth.updated_at` → `created_at=auth.created_at`に修正</td>
