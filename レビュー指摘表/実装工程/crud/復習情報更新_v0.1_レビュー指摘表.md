<table style="border-collapse: collapse;">
    <tr>
        ...
        <th colspan="2" style="border: 3px solid white;">update_review</th>
    ...
    <tr>
        ...
        <td style="border: 1px solid white;">256行目で`if not review: return None`によりreviewがNoneの場合は既にreturnしている。261行目の`if review:`は常にTrueとなる冗長な条件チェックである。削除すべきである。</td>
        <td style="border: 1px solid white;">261</td>
        ...
        <td style="border: 1px solid white;">該当条件は「入力値．復習項目が未設定の場合」であるため、`if review_item:`に修正する。</td>
        <td style="border: 1px solid white;">`# 1.(1) REVIEWテーブルを更新（つづき）` の `if review:` を `if review_item:`に修正</td>
